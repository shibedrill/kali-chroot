...
echo "by shibedrill"
echo "This script will automatically configure a Chroot environment in which to run many Kali Linux tools."
echo "Now please notice: Wireless tools will not work out of the box. However, most other tools will."
echo "Metasploit, password tools, GUI tools like Burp and Wireshark, and net tools like nmap will work."
echo ""
...
apt update && apt install debootstrap schroot wget sed -y
...
# Finished!
echo "Once you configure your aliases, use the command 'kali' to enter your chroot. Enjoy!"
