...
echo "${RED}Warning! This is a very hacky patch, and it might not work.${NC}"
...
if [ -f /home/"$SUDO_USER"/.bash_aliases ]
  then echo "alias kali='xhost + && schroot -c kali -u root -d /root && schroot -e --all-sessions && xhost -'" >> /home/"$SUDO_USER"/.bash_aliases && echo "${PURPLE}Alias added to your ~/.bash_aliases file. You can use your chroot by running the comman ' kali '.${NC}"
