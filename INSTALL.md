...
The only requirements are the script, internet access, BASH, and a supported package manager.
...
1. Run the uninstall script with Sudo. Your command should look like this:
` sudo bash ./uninstall.sh `
2. If the script fails to locate the alias for the chroot, it will notify you, and you must remove it manually.
